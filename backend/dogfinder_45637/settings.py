"""
Django settings for dogfinder_45637 project.
...
ROOT_URLCONF = 'dogfinder_45637.urls'
...
WSGI_APPLICATION = 'dogfinder_45637.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dogfinder_45637 API",
    "DESCRIPTION": "API documentation for dogfinder_45637 App",
    "VERSION": "v1",
}
